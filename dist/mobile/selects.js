        ...
        (0, vue_1.onMounted)(function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _a.value = _b.apply(void 0, [(_c.sent()).concat(props.modelValue), 'value']);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    render: function () {
        ...
        return (0, vue_1.h)('div', { class: 'childcctx' }, [
            ...
            (0, vue_1.h)('div', { class: 'childccc' }, [
                (0, vue_1.h)(ant_design_vue_1.Select, __assign(__assign({ class: 'childcccs', value: this.current, mode: 'multiple', size: 'small', showSearch: true, filterOption: function (input, option) { return option.value.toLowerCase().indexOf(input.toLowerCase()) >= 0; }, allowClear: true }, (this.option.props || {})), { options: (0, lodash_1.map)(this.options, function (option) { return ({ value: JSON.stringify(option), label: option.label }); }), onChange: function (current) { return _this.current = current; }, getPopupContainer: function (el) { return el.parentElement; } }), []),
                // h(Select, {
            ...
            (0, vue_1.h)('div', { class: 'childccf' }, [
                (0, vue_1.h)(ant_design_vue_1.Button, {
                    ...
                    onClick: function () { return _this.value = (0, lodash_1.map)(_this.current, function (data) { return JSON.parse(data); }); },
                }, ["\u786E\u5B9A"]),
...
//# sourceMappingURL=../.sourcemaps/mobile/selects.js.map
