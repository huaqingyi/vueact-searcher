    ...
    render: function () {
        ...
        return (0, vue_1.h)('div', { class: 'childcctx' }, [
            ...
            (0, vue_1.h)('div', { class: 'childccc' }, [
                (0, vue_1.h)(ant_design_vue_1.Select, __assign(__assign({ class: 'childcccs', value: this.current, size: 'small', mode: 'tags' }, (this.option.props || {})), { onChange: function (current) { return _this.current = current; }, getPopupContainer: function (el) { return el.parentElement; } }), []),
            ]),
...
function getLabel(option) {
    var _a;
    return _a = {}, _a["".concat(option.label, ": ").concat((0, lodash_1.map)(option.current, function (value) { return value; }).join(','))] = option.value, _a;
}
exports.getLabel = getLabel;

//# sourceMappingURL=../.sourcemaps/mobile/tags.js.map
