...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup: function (props) {
        ...
        return { options: options, value: value, onChange: onChange, visible: visible, onVisibleChange: onVisibleChange, SearcherType: types_1.SearcherType };
    },
    render: function () {
        var _this = this;
        return (0, vue_1.h)('div', { class: 'searcher-root mobile', onMousedown: function (e) { return e.stopPropagation(); } }, [
            ...
            (0, vue_1.h)(vant_1.Popup, {
                show: this.visible, 'onUpdate:show': function (visible) { return _this.visible = visible; },
                round: true, position: 'bottom',
            }, [
                (0, vue_1.h)(vant_1.PickerGroup, {
                    title: '', tabs: (0, lodash_1.map)(this.options, function (_a) {
                        var label = _a.label;
                        return label;
                    }),
                    onConfirm: function () { }, onCancel: function () { },
                }, (0, lodash_1.map)(this.options, function (option) {
                    return (0, vue_1.h)('div', {}, [option.label]);
                })),
            ]),
        ]);
    },
...
//# sourceMappingURL=../.sourcemaps/mobile/app.js.map
